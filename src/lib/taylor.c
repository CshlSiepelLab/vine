...
double elbo_taylor(TreeModel *mod, multi_MVN *mmvn, CovarData *data,
  ...
  if (do_refresh && var_at_floor(mmvn, data))
    do_refresh = FALSE;
...
*/
double elbo_hybrid(TreeModel *mod, multi_MVN *mmvn, CovarData *data,
